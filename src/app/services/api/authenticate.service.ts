...
export class AuthenticateService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiAuthenticateRegisterPost(body?: UserVM, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiAuthenticateRegisterPost(body?: UserVM, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiAuthenticateRegisterPost(body?: UserVM, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiAuthenticateRegisterPost(body?: UserVM, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
